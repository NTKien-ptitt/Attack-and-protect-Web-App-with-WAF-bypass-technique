...
if (isset($_POST['login'])) {
    // Không s? d?ng mysqli_real_escape_string
    $email = $_POST['email'];
    $password = $_POST['password'];

    // T?o câu l?nh SQL d? b? t?n công
...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">login to <a href="index.php"><span>bookflix & </span><span>Chill</span></a></h3>
            <input type="text" name="email" placeholder="Enter Email Id" required class="text_field">
